...
TwoWire::TwoWire(Twi *_twi, void(*_beginCb)(void)) :
	...
	onRequestCallback(0), onReceiveCallback(0), onBeginCallback(_beginCb), twi(_twi),
...
static void Wire_Init(void) {
	...
	ConfigurePin(g_APinDescription[PIN_WIRE_SDA]);
	ConfigurePin(g_APinDescription[PIN_WIRE_SCL]);
...
static void Wire1_Init(void) {
	...
	ConfigurePin(g_APinDescription[PIN_WIRE1_SDA]);
	ConfigurePin(g_APinDescription[PIN_WIRE1_SCL]);
